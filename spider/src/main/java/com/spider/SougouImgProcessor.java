 ...
 * @Author jh
 * @Description
 * @Date created in 15:30 2022/6/17
 */
import com.alibaba.fastjson.JSONObject;
import com.spider.HttpClientUtils;
import com.spider.SougouImgPipeline;
...
//        pipeline.process(this.urlList, word);   // 单线程
    ...
    public static void main(String[] args) {
        ...
        SougouImgProcessor processor = new SougouImgProcessor(url,"蔡徐坤歌曲封面");
